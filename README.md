...
- **Native Screen Reading**: Extends Kiko's vision beyond physical files by hooking into the native Microsoft UI Automation (UIA) API to crawl accessibility trees of active web browsers or applications, completely avoiding fragile OCR engines.
